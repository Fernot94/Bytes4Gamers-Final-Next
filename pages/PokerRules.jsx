  ...
  return (
    <div className="mainPokerRules">
      ...
      <div className="handRanking">
        ...
        <p>Before you hit the online poker tables, you’ll need to familiarise yourself with the basic hand rankings and rules that govern Texas Hold’em. Here are the 10 hands every player should know before joining the action.</p>
        <div className="hands">
          <div>
            <img className="handExemple" src="/royal-flush.png" alt="Royal Straight Flush" />
            <h3>Royal Straight Flush</h3>
            <p>Poker’s most famous hand, a royal straight flush, cannot be beaten. It consists of the ace, king, queen, jack and ten of a single suit.</p>
          </div>
          <div>
            <img className="handExemple" src="/straight-flush.webp" alt="Straight Flush" />
          ...
          <div>
            <img className="handExemple" src="/four-of-a-kind.webp" alt="Four of a Kind" />
          ...
          <div>
            <img className="handExemple" src="/full-house.png" alt="Full House" />
            <h3>Full House</h3>
          ...
          <div>
            <img className="handExemple" src="/two-pair.webp" alt="Two Pair" />
            <h3>Two Pair</h3>
          ...
          <div>
            <img className="handExemple" src="/pair.webp" alt="Pair" />
            <h3>Pair</h3>
          ...
          <div>
            <img className="handExemple" src="/high-card.png" alt="High Card" />
            <h3>High Card</h3>
